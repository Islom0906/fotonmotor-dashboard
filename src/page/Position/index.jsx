...
const Position = () => {
    ...
    // get
    const {data,isLoading:getBannerLoading,refetch}=useGetQuery(false,'position-get','/position/',false)
    ...
    const searchFunc = (value) => {
        ...
        const filterData = data?.filter(
            (data) => data.titleRu.toLowerCase().includes(value.toLowerCase())|| data.titleUz.toLowerCase().includes(value.toLowerCase()));
